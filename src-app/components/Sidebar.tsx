                ...
                <div className="navbar bg-dark-50 border border-dark-300 shadow-none rounded-lg">
                    <div className="navbar-start justify-between">
                        ...
                        <span className="relative inline-flex">
                            ...
                            />
                            {appState.fileServerRunning && (
                                <span className="flex absolute size-3 top-0 right-0 -mt-1 -mr-1">
                                    <span className="animate-ping absolute inline-flex size-full rounded-full bg-orange-300 opacity-75"></span>
